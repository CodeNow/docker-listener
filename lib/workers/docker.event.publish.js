...
function DockerEventPublish (job) {
  ...
  return Promise
    .try(function () {
      var event = DockerEventPublish._addBasicFields(job)
      ...
      return sinceMap.set(event.ip, event.time)
        .then(function () {
          return Promise.fromCallback(function (cb) {
            ...
            var timer = datadog.timer('inspect.time', event.ip, event.org)
