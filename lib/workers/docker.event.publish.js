...
const DockerEventPublish = (job) => {
  return Promise
    .try((cb) => {
      ...
      let inspect = _getInspectFunction(job)
...
DockerEventPublish._getInspectFunction (job) => {
  if (DockerEventPublish._isBuildContainer(job)) {
    return DockerEventPublish._handleImageInspect(job)
  }

  return DockerEventPublish._handleContainerInspect(job)
}
...
DockerEventPublish._handleContainerInspect = (job) => {
...
DockerEventPublish._handleImageInspect = (job) => {
